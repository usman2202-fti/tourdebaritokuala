    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
          ...
          <form class="form" enctype="multipart/form-data" role="form" method="post" action="{{ route('register_save_rb')}}">
            @method('post')
            @csrf
            <table>
              <tr>
                ...
                <td class="col-md-10" style="padding: 2px">
                    <select name="kategori" class="form-control" required>
                        ...
                        <option value="Men Youth">Men Youth (13 - 16 Thn)</option>
                        <option value="Men Junior">Men Junior (17 - 18 Thn)</option>
                        <option value="Men Elite">Men Elite (19 - 29 Thn)</option>
                        <option value="Women Open">Women Open (Semua Umur)</option>
                        <option value="Men Master A">Men Master A (30 - 40 Thn)</option>
                        <option value="Men Master B">Men Master B (41 Thn Keatas)</option>
                    </select>
                </td>
              </tr>  
              <tr>
